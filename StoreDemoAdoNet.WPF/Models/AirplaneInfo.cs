...
{
    public class AirplaneInfo :BaseNotify
    {
        private int _id;
        ...
        private string _passengerDetail;
        private string _ticketDetail;       
        ...
        {
            get => _passengerDetail;
            set => SetField(ref _passengerDetail, value);
        }

        public string TicketDetail
        {
            get => _ticketDetail;
            set => SetField(ref _ticketDetail, value);
        }
